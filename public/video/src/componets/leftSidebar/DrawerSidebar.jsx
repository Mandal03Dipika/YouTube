...
function DrawerSidebar({ toggleDrawer, toggleDrawerSidebar }) {
  return (
    <>
      <div className="container_drawer_left" style={toggleDrawerSidebar}>
        <div className="container2_drawer_left">
          <div className="drawer_left_sidebar">
            ...
            <div className="icon_sidebar_div">
              <NavLink to={"/chanel/1"} className="icon_sidebar_div">
                <p>
                  <IoMdAlbums
                    size={22}
                    className={"icon_sidebar"}
                    style={{ margin: "auto 0.7rem" }}
                  />
                  <div className="text_sidebar_icon">Your Chanel</div>
                </p>
              </NavLink>
            </div>
        ...
        <div
          className="container3_drawer_left"
